...
export default function Footer() {
  return (
    <div className='relative bg-[#f1f3f5] md:h-[70vh] w-full p-5 text-black '>
      <div className='flex flex-col space-y-4 md:space-y-0 justify-center items-start md:justify-between md:items-start md:flex-row md:pt-20 md:px-12 '>
        {/* COMPANY */}
        <div className='space-y-2 md:space-y-4'>
          <h2 className='text-md text-start md:text-lg font-extrabold '>Company</h2>
          <div className='flex flex-col md:space-y-4 text-[#009245] md:text-md md:font-bold'>
        ...
        {/* PRODUCTS */}
        <div className='space-y-2 md:space-y-4'>
          <h2 className='text-md text-start md:text-lg font-extrabold '>AI Rider</h2>
          <div className='flex flex-col md:space-y-4 text-[#009245] md:text-md md:font-bold'>
            <Link href='#'>Our Products</Link>
        ...
        {/* CONTACT US */}
        <div className='space-y-2 md:space-y-4'>
          <h2 className='text-md text-start md:text-lg font-extrabold '>Contact Us</h2>
          <div className='flex flex-col md:space-y-4 text-[#009245] md:text-md md:font-bold'>
        ...
        <div className='space-y-2 md:space-y-4 mt-0'>
          <h2 className='text-md text-start md:text-lg font-extrabold '>Socials</h2>
